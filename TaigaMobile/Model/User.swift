...
extension User {
    class UserClass: NSObject, NSCoding {
        ...
        required init?(coder aDecoder: NSCoder) {
            guard let authToken = aDecoder.decodeObject(forKey: "authToken") as? String else { user = nil; super.init(); return nil }
            guard let bio = aDecoder.decodeObject(forKey: "bio") as? String else { user = nil; super.init(); return nil }
            guard let email = aDecoder.decodeObject(forKey: "email") as? String else { user = nil; super.init(); return nil }
            guard let fullName = aDecoder.decodeObject(forKey: "fullName") as? String else { user = nil; super.init(); return nil }
            guard let username = aDecoder.decodeObject(forKey: "username") as? String else { user = nil; super.init(); return nil }
            guard let photo = aDecoder.decodeObject(forKey: "photo") as? String else { user = nil; super.init(); return nil }
